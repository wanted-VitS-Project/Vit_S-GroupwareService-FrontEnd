    ...
    >
      {toasts.map((toast) => (
        <div
          ...
          className={`pointer-events-auto max-w-sm animate-panel-in rounded-lg border px-3.5 py-2.5 text-detail leading-snug font-medium shadow-lg motion-reduce:animate-none ${
            toast.tone === 'error'
