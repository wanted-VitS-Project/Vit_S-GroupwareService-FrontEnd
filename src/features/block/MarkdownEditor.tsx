...
export const MARKDOWN_CLASS = [
  ...
  '[&_code]:rounded [&_code]:bg-bg-surface [&_code]:px-1 [&_code]:font-mono [&_code]:text-[10px] [&_code]:text-text-danger',
  '[&_pre]:my-1.5 [&_pre]:rounded [&_pre]:bg-bg-surface [&_pre]:p-2',
