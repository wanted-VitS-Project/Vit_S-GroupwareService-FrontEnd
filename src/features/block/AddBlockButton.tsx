  ...
  return (
    <>
      <button
        ...
        className="flex shrink-0 cursor-pointer items-center gap-1.5 rounded-lg bg-btn-primary px-3 py-1.5 text-[11px] font-semibold text-text-white hover:bg-btn-primary-hover"
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
