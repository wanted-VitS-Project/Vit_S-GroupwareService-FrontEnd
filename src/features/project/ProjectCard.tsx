...
/**
 * 카드 머리글 한 줄의 **격자**. 머리글 라벨(`ProjectListHeader`) · 카드 · 스켈레톤이
 * 이 하나를 함께 쓴다.
 *
 ...
 * 로 겹치면 `24×5 − 6×4 = 96px`. `AVATAR_LIMIT` 을 바꾸면 이 값도 함께 고쳐야 한다.
 *
...
const TOGGLE_SLOT = 'size-9 shrink-0';
    ...
    >
      ...
      >
        ...
        <button
          ...
          className={`${TOGGLE_SLOT} flex cursor-pointer items-center justify-center rounded-lg hover:bg-black/[0.05]`}
        >
